...
pega.namespace("pega.desktop.nbaa");
pega.desktop.nbaa.scrollposition = 0;
pega.desktop.nbaa.scrollelem = null;

pega.desktop.nbaa.saveScrollPosition = function(event){
  pega.desktop.nbaa.scrollelem = event.target.closest(".harnessContent");
  pega.desktop.nbaa.scrollposition = pega.desktop.nbaa.scrollelem.querySelector(".MultilevelScrollIP div[data-node-id='NegotiateOffer']").scrollTop;
};
pega.desktop.nbaa.restoreScrollPosition = function(){
  setTimeout( function() { 
    if(pega.desktop.nbaa.scrollelem !== null) {
      pega.desktop.nbaa.scrollelem.querySelector(".MultilevelScrollIP div[data-node-id='NegotiateOffer']").scrollTop = pega.desktop.nbaa.scrollposition;
    }
  }, 10);
};
