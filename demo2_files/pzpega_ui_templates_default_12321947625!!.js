...
>{{~#if (ifCond (ifCond pyIsLayoutGroup 'eq' false) 'and' (ifCond genContentInner 'eq' true)) ~}}
  ...
  {{~/if~}}
    ...
    {{~#ifCond pyType '==' "field"~}}    
      ...
      {{~#if pyIsCellReadOnly~}}
        <span {{pyAutomationID}} class="{{pyLabelParentClass}} {{pyLabelClass}}" >
      {{~#if pybParam~}}
            <input type="hidden" name="{{pyParamName}}" value="{{pyParamValue}}">{{pyLocalizedParamValue}}
          {{~else~}}
        ...
        <i data-ctl="Icon" class="icons pi pi-help pi-link helper-icon" title="{{{pyHelperVal}}}" onclick="pd(event);" tabindex="-1" role="img" aria-label="{{pyHelperVal}}"></i>
      {{~/if~}}{{~/if~}}
        {{~#if pyHelperLabelOnFocus~}}{{~#if pyHelperTextIconOnFocus~}}
                <span class="helper-icon-tooltip-parent">
                  <i data-ctl="Icon" class="icons pi pi-help pi-link helper-icon" aria-label="help" data-hover="[[&quot;showSmartTip&quot;,[&quot;:event&quot;,&quot;&quot;,&quot;{{pyHelperVal}}&quot;]]]" data-click="[[&quot;showSmartTip&quot;,[&quot;:event&quot;,&quot;&quot;,&quot;{{pyHelperVal}}&quot;]]]" onmouseover="pega.c.cbe.processHoverEvent(event)" data-keydown="[[&quot;showSmartTip&quot;,[&quot;:event&quot;,&quot;&quot;,&quot;{{pyHelperVal}}&quot;],,&quot;enter&quot;]]" tabindex="{{pyHelperTabIndex}}" role="button" >
                  </i>
      {{~/if~}}{{~/if~}}
        </span>
      {{~else~}}
        {{~#if pybParam~}}
        {{~#if pyHelperLabelOnFocus~}}{{~#if pyHelperTextIconOnFocus~}}
                <div class="{{{pyLabelParentClass}}}" >
            {{~/if~}}{{~/if~}}
          <label {{pyAutomationID}} class="{{pyLabelParentClass}} {{pyLabelClass}}" for="{{pyForStrLabel}}"><input type="hidden" name="{{pyParamName}}" value="{{pyParamValue}}">{{pyLocalizedParamValue}}</label>
      {{~#if pyHelperLabel~}}{{~#if pyHelperTextIcon~}}
        <i data-ctl="Icon" class="icons pi pi-help pi-link helper-icon" title="{{{pyHelperVal}}}" onclick="pd(event);" tabindex="-1" role="img" aria-label="{{pyHelperVal}}"></i>
      {{~/if~}}{{~/if~}}
        {{~#if pyHelperLabelOnFocus~}}
              {{~#if pyHelperTextIconOnFocus~}}
              <span class="helper-icon-tooltip-parent">
                <i data-ctl="Icon" class="icons pi pi-help pi-link helper-icon" aria-label="help" data-hover="[[&quot;showSmartTip&quot;,[&quot;:event&quot;,&quot;&quot;,&quot;{{pyHelperVal}}&quot;]]]" data-click="[[&quot;showSmartTip&quot;,[&quot;:event&quot;,&quot;&quot;,&quot;{{pyHelperVal}}&quot;]]]" onmouseover="pega.c.cbe.processHoverEvent(event)" data-keydown="[[&quot;showSmartTip&quot;,[&quot;:event&quot;,&quot;&quot;,&quot;{{pyHelperVal}}&quot;],,&quot;enter&quot;]]" tabindex="{{pyHelperTabIndex}}" role="button" >
                </i>
              </span>
      ...
      {{~/if~}}
        {{~else~}}
          ...
          {{~#if pyHelperLabelOnFocus~}}
              ...
              {{~/if~}}
            {{~/if~}}
          <label {{pyAutomationID}} class="{{pyLabelParentClass}} {{pyLabelClass}}{{~#ifCond pyIsChildNonTemplate '!=' true ~}}{{#ifCond IsCustomerRequiredFormat '==' 'false'}} icon-required {{/ifCond}}{{/ifCond}}" for="{{pyForStrLabel}}" {{~#ifCond pyIsChildNonTemplate '!=' true ~}} data-required="{{pyCustomRequireFormat}}" {{/ifCond}}>
          {{~#ifCond pyLabelValue '!=' ".pyTemplateInputBox"~}}
            {{~#ifCond pyLabelValue '!=' ""~}} 
      ...
      {{~/if~}}{{~/if~}}
          ...
          {{~#ifCond pyFormat '==' 'pxRichTextEditor'~}}{{~#ifCond pyIsCellReadOnly '!=' true~}}
           <i data-ctl="Icon" class="icons pi pi-keyboard" title=\"Keyboard shortcuts\" onkeydown="pega.ui.RichTextEditor.prototype.showSmartInfoContent(event)" onclick="pega.control.Actions.prototype.showSmartTip(event, '', window.rte_smartinfo_content, '');" tabindex="0" aria-label="Keyboard shortcuts" role="button"></i>
           </div>
          {{~/ifCond~}}{{~/ifCond~}}          
          {{~#if pyHelperLabelOnFocus~}}{{~#if pyHelperTextIconOnFocus~}}
                <span class="helper-icon-tooltip-parent">
  ...
  {{~#if (ifCond (ifCond pyType 'eq' "sub_section") 'or' (ifCond pyType 'eq' "layout")) ~}}   
    {{~#ifCond pyLabelValue '!=' ""~}}
      {{~#if pyLabelReserveSpace~}}
        {{~#if pybParam~}}
          <label class="{{pyLabelParentClass}} {{pyLabelClass}}"><input type="hidden" name="{{pyParamName}}" value="{{pyParamValue}}">{{pyLocalizedParamValue}}</label>
        {{~else~}}
        <label class="{{pyLabelParentClass}} {{pyLabelClass}}">{{{pyLabelValue}}}</label>
        {{~/if~}}
      {{~/if~}}
    {{~/ifCond~}} 
        {{~{getDLCellControl metaData}~}}        
...
templates['pzpega_ui_DLCellTemplate'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "<div "
    ...
    + ((stack1 = (lookupProperty(helpers,"ifCond")||(depth0 && lookupProperty(depth0,"ifCond"))||container.hooks.helperMissing).call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? lookupProperty(depth0,"pyType") : depth0),"==","field",{"name":"ifCond","hash":{},"fn":container.program(38, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":39,"column":4},"end":{"line":138,"column":17}}})) != null ? stack1 : "")
    + ((stack1 = (lookupProperty(helpers,"ifCond")||(depth0 && lookupProperty(depth0,"ifCond"))||container.hooks.helperMissing).call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? lookupProperty(depth0,"pyType") : depth0),"==","paragraph",{"name":"ifCond","hash":{},"fn":container.program(93, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":139,"column":4},"end":{"line":141,"column":17}}})) != null ? stack1 : "")
    + ((stack1 = (lookupProperty(helpers,"ifCond")||(depth0 && lookupProperty(depth0,"ifCond"))||container.hooks.helperMissing).call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? lookupProperty(depth0,"pyType") : depth0),"==","microdc",{"name":"ifCond","hash":{},"fn":container.program(93, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":142,"column":4},"end":{"line":144,"column":17}}})) != null ? stack1 : "")
    + ((stack1 = lookupProperty(helpers,"if").call(depth0 != null ? depth0 : (container.nullContext || {}),(lookupProperty(helpers,"ifCond")||(depth0 && lookupProperty(depth0,"ifCond"))||container.hooks.helperMissing).call(depth0 != null ? depth0 : (container.nullContext || {}),(lookupProperty(helpers,"ifCond")||(depth0 && lookupProperty(depth0,"ifCond"))||container.hooks.helperMissing).call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? lookupProperty(depth0,"pyType") : depth0),"eq","sub_section",{"name":"ifCond","hash":{},"data":data,"loc":{"start":{"line":145,"column":17},"end":{"line":145,"column":51}}}),"or",(lookupProperty(helpers,"ifCond")||(depth0 && lookupProperty(depth0,"ifCond"))||container.hooks.helperMissing).call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? lookupProperty(depth0,"pyType") : depth0),"eq","layout",{"name":"ifCond","hash":{},"data":data,"loc":{"start":{"line":145,"column":57},"end":{"line":145,"column":86}}}),{"name":"ifCond","hash":{},"data":data,"loc":{"start":{"line":145,"column":9},"end":{"line":145,"column":87}}}),{"name":"if","hash":{},"fn":container.program(95, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":145,"column":2},"end":{"line":156,"column":13}}})) != null ? stack1 : "")
    + ((stack1 = lookupProperty(helpers,"if").call(depth0 != null ? depth0 : (container.nullContext || {}),(lookupProperty(helpers,"ifCond")||(depth0 && lookupProperty(depth0,"ifCond"))||container.hooks.helperMissing).call(depth0 != null ? depth0 : (container.nullContext || {}),(lookupProperty(helpers,"ifCond")||(depth0 && lookupProperty(depth0,"ifCond"))||container.hooks.helperMissing).call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? lookupProperty(depth0,"pyIsLayoutGroup") : depth0),"eq",false,{"name":"ifCond","hash":{},"data":data,"loc":{"start":{"line":157,"column":17},"end":{"line":157,"column":52}}}),"and",(lookupProperty(helpers,"ifCond")||(depth0 && lookupProperty(depth0,"ifCond"))||container.hooks.helperMissing).call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? lookupProperty(depth0,"genContentInner") : depth0),"eq",true,{"name":"ifCond","hash":{},"data":data,"loc":{"start":{"line":157,"column":59},"end":{"line":157,"column":93}}}),{"name":"ifCond","hash":{},"data":data,"loc":{"start":{"line":157,"column":9},"end":{"line":157,"column":94}}}),{"name":"if","hash":{},"fn":container.program(36, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":157,"column":2},"end":{"line":159,"column":11}}})) != null ? stack1 : "")
    + "</div>";
},"2":function(container,depth0,helpers,partials,data) {
    var helper, lookupProperty = container.lookupProperty || function(parent, propertyName) {
        if (Object.prototype.hasOwnProperty.call(parent, propertyName)) {
  ...
  return ((stack1 = lookupProperty(helpers,"if").call(depth0 != null ? depth0 : (container.nullContext || {}),(lookupProperty(helpers,"ifCond")||(depth0 && lookupProperty(depth0,"ifCond"))||container.hooks.helperMissing).call(depth0 != null ? depth0 : (container.nullContext || {}),(lookupProperty(helpers,"ifCond")||(depth0 && lookupProperty(depth0,"ifCond"))||container.hooks.helperMissing).call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? lookupProperty(depth0,"pyLabelReserveSpace") : depth0),"eq",true,{"name":"ifCond","hash":{},"data":data,"loc":{"start":{"line":40,"column":20},"end":{"line":40,"column":58}}}),"and",(lookupProperty(helpers,"ifCond")||(depth0 && lookupProperty(depth0,"ifCond"))||container.hooks.helperMissing).call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? lookupProperty(depth0,"pyFormat") : depth0),"neq","pxHidden",{"name":"ifCond","hash":{},"data":data,"loc":{"start":{"line":40,"column":65},"end":{"line":40,"column":99}}}),{"name":"ifCond","hash":{},"data":data,"loc":{"start":{"line":40,"column":12},"end":{"line":40,"column":100}}}),{"name":"if","hash":{},"fn":container.program(39, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":40,"column":6},"end":{"line":126,"column":11}}})) != null ? stack1 : "")
    + ((stack1 = lookupProperty(helpers,"if").call(depth0 != null ? depth0 : (container.nullContext || {}),(lookupProperty(helpers,"ifCond")||(depth0 && lookupProperty(depth0,"ifCond"))||container.hooks.helperMissing).call(depth0 != null ? depth0 : (container.nullContext || {}),(lookupProperty(helpers,"ifCond")||(depth0 && lookupProperty(depth0,"ifCond"))||container.hooks.helperMissing).call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? lookupProperty(depth0,"pyLabelReserveSpace") : depth0),"eq",true,{"name":"ifCond","hash":{},"data":data,"loc":{"start":{"line":128,"column":21},"end":{"line":128,"column":59}}}),"or",(lookupProperty(helpers,"ifCond")||(depth0 && lookupProperty(depth0,"ifCond"))||container.hooks.helperMissing).call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? lookupProperty(depth0,"pyFlex") : depth0),"eq",false,{"name":"ifCond","hash":{},"data":data,"loc":{"start":{"line":128,"column":65},"end":{"line":128,"column":91}}}),{"name":"ifCond","hash":{},"data":data,"loc":{"start":{"line":128,"column":13},"end":{"line":128,"column":92}}}),{"name":"if","hash":{},"fn":container.program(87, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":128,"column":6},"end":{"line":130,"column":13}}})) != null ? stack1 : "")
    + ((stack1 = (lookupProperty(helpers,"ifCond")||(depth0 && lookupProperty(depth0,"ifCond"))||container.hooks.helperMissing).call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? lookupProperty(depth0,"pyFormat") : depth0),"==","pxHidden",{"name":"ifCond","hash":{},"fn":container.program(89, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":131,"column":8},"end":{"line":131,"column":61}}})) != null ? stack1 : "")
    ...
    + ((stack1 = (lookupProperty(helpers,"ifCond")||(depth0 && lookupProperty(depth0,"ifCond"))||container.hooks.helperMissing).call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? lookupProperty(depth0,"pyFormat") : depth0),"==","pxHidden",{"name":"ifCond","hash":{},"fn":container.program(91, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":133,"column":8},"end":{"line":133,"column":62}}})) != null ? stack1 : "")
    + ((stack1 = lookupProperty(helpers,"if").call(depth0 != null ? depth0 : (container.nullContext || {}),(lookupProperty(helpers,"ifCond")||(depth0 && lookupProperty(depth0,"ifCond"))||container.hooks.helperMissing).call(depth0 != null ? depth0 : (container.nullContext || {}),(lookupProperty(helpers,"ifCond")||(depth0 && lookupProperty(depth0,"ifCond"))||container.hooks.helperMissing).call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? lookupProperty(depth0,"pyLabelReserveSpace") : depth0),"eq",true,{"name":"ifCond","hash":{},"data":data,"loc":{"start":{"line":134,"column":19},"end":{"line":134,"column":57}}}),"or",(lookupProperty(helpers,"ifCond")||(depth0 && lookupProperty(depth0,"ifCond"))||container.hooks.helperMissing).call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? lookupProperty(depth0,"pyFlex") : depth0),"eq",false,{"name":"ifCond","hash":{},"data":data,"loc":{"start":{"line":134,"column":63},"end":{"line":134,"column":89}}}),{"name":"ifCond","hash":{},"data":data,"loc":{"start":{"line":134,"column":11},"end":{"line":134,"column":90}}}),{"name":"if","hash":{},"fn":container.program(36, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":134,"column":4},"end":{"line":136,"column":17}}})) != null ? stack1 : "")
    + ((stack1 = ((helper = (helper = lookupProperty(helpers,"pyUiFieldValueMeta") || (depth0 != null ? lookupProperty(depth0,"pyUiFieldValueMeta") : depth0)) != null ? helper : container.hooks.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : (container.nullContext || {}),{"name":"pyUiFieldValueMeta","hash":{},"data":data,"loc":{"start":{"line":137,"column":8},"end":{"line":137,"column":32}}}) : helper))) != null ? stack1 : "");
},"39":function(container,depth0,helpers,partials,data) {
    var stack1, lookupProperty = container.lookupProperty || function(parent, propertyName) {
        if (Object.prototype.hasOwnProperty.call(parent, propertyName)) {
          return parent[propertyName];
  ...
  return ((stack1 = lookupProperty(helpers,"if").call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? lookupProperty(depth0,"pyIsCellReadOnly") : depth0),{"name":"if","hash":{},"fn":container.program(40, data, 0),"inverse":container.program(58, data, 0),"data":data,"loc":{"start":{"line":41,"column":6},"end":{"line":125,"column":15}}})) != null ? stack1 : "");
},"40":function(container,depth0,helpers,partials,data) {
    var stack1, helper, lookupProperty = container.lookupProperty || function(parent, propertyName) {
        if (Object.prototype.hasOwnProperty.call(parent, propertyName)) {
          return parent[propertyName];
  ...
  return "<span "
    ...
    + " class=\""
    + container.escapeExpression(((helper = (helper = lookupProperty(helpers,"pyLabelParentClass") || (depth0 != null ? lookupProperty(depth0,"pyLabelParentClass") : depth0)) != null ? helper : container.hooks.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : (container.nullContext || {}),{"name":"pyLabelParentClass","hash":{},"data":data,"loc":{"start":{"line":42,"column":40},"end":{"line":42,"column":62}}}) : helper)))
    + " "
    + container.escapeExpression(((helper = (helper = lookupProperty(helpers,"pyLabelClass") || (depth0 != null ? lookupProperty(depth0,"pyLabelClass") : depth0)) != null ? helper : container.hooks.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : (container.nullContext || {}),{"name":"pyLabelClass","hash":{},"data":data,"loc":{"start":{"line":42,"column":63},"end":{"line":42,"column":79}}}) : helper)))
    + "\" >"
    ...
    + ((stack1 = lookupProperty(helpers,"if").call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? lookupProperty(depth0,"pyHelperLabelOnFocus") : depth0),{"name":"if","hash":{},"fn":container.program(55, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":60,"column":8},"end":{"line":64,"column":24}}})) != null ? stack1 : "")
    + "</span>";
},"41":function(container,depth0,helpers,partials,data) {
    var stack1, lookupProperty = container.lookupProperty || function(parent, propertyName) {
        if (Object.prototype.hasOwnProperty.call(parent, propertyName)) {
  ...
  return ((stack1 = lookupProperty(helpers,"if").call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? lookupProperty(depth0,"pyHelperTextIconOnFocus") : depth0),{"name":"if","hash":{},"fn":container.program(56, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":60,"column":38},"end":{"line":64,"column":15}}})) != null ? stack1 : "");
  ...
  return "<span class=\"helper-icon-tooltip-parent\">\n                  <i data-ctl=\"Icon\" class=\"icons pi pi-help pi-link helper-icon\" aria-label=\"help\" data-hover=\"[[&quot;showSmartTip&quot;,[&quot;:event&quot;,&quot;&quot;,&quot;"
    + container.escapeExpression(((helper = (helper = lookupProperty(helpers,"pyHelperVal") || (depth0 != null ? lookupProperty(depth0,"pyHelperVal") : depth0)) != null ? helper : container.hooks.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : (container.nullContext || {}),{"name":"pyHelperVal","hash":{},"data":data,"loc":{"start":{"line":62,"column":178},"end":{"line":62,"column":193}}}) : helper)))
    + "&quot;]]]\" data-click=\"[[&quot;showSmartTip&quot;,[&quot;:event&quot;,&quot;&quot;,&quot;"
    + container.escapeExpression(((helper = (helper = lookupProperty(helpers,"pyHelperVal") || (depth0 != null ? lookupProperty(depth0,"pyHelperVal") : depth0)) != null ? helper : container.hooks.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : (container.nullContext || {}),{"name":"pyHelperVal","hash":{},"data":data,"loc":{"start":{"line":62,"column":282},"end":{"line":62,"column":297}}}) : helper)))
    + "&quot;]]]\" onmouseover=\"pega.c.cbe.processHoverEvent(event)\" data-keydown=\"[[&quot;showSmartTip&quot;,[&quot;:event&quot;,&quot;&quot;,&quot;"
    + container.escapeExpression(((helper = (helper = lookupProperty(helpers,"pyHelperVal") || (depth0 != null ? lookupProperty(depth0,"pyHelperVal") : depth0)) != null ? helper : container.hooks.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : (container.nullContext || {}),{"name":"pyHelperVal","hash":{},"data":data,"loc":{"start":{"line":62,"column":438},"end":{"line":62,"column":453}}}) : helper)))
    + "&quot;],,&quot;enter&quot;]]\" tabindex=\""
    + container.escapeExpression(((helper = (helper = lookupProperty(helpers,"pyHelperTabIndex") || (depth0 != null ? lookupProperty(depth0,"pyHelperTabIndex") : depth0)) != null ? helper : container.hooks.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : (container.nullContext || {}),{"name":"pyHelperTabIndex","hash":{},"data":data,"loc":{"start":{"line":62,"column":493},"end":{"line":62,"column":513}}}) : helper)))
    + "\" role=\"button\" >\n                  </i>";
  ...
  return ((stack1 = lookupProperty(helpers,"if").call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? lookupProperty(depth0,"pybParam") : depth0),{"name":"if","hash":{},"fn":container.program(59, data, 0),"inverse":container.program(66, data, 0),"data":data,"loc":{"start":{"line":67,"column":8},"end":{"line":124,"column":17}}})) != null ? stack1 : "");
},"59":function(container,depth0,helpers,partials,data) {
    var stack1, helper, lookupProperty = container.lookupProperty || function(parent, propertyName) {
        if (Object.prototype.hasOwnProperty.call(parent, propertyName)) {
          return parent[propertyName];
  ...
  return ((stack1 = lookupProperty(helpers,"if").call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? lookupProperty(depth0,"pyHelperLabelOnFocus") : depth0),{"name":"if","hash":{},"fn":container.program(60, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":68,"column":8},"end":{"line":70,"column":30}}})) != null ? stack1 : "")
    + "<label "
    ...
    + " class=\""
    + container.escapeExpression(((helper = (helper = lookupProperty(helpers,"pyLabelParentClass") || (depth0 != null ? lookupProperty(depth0,"pyLabelParentClass") : depth0)) != null ? helper : container.hooks.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : (container.nullContext || {}),{"name":"pyLabelParentClass","hash":{},"data":data,"loc":{"start":{"line":71,"column":43},"end":{"line":71,"column":65}}}) : helper)))
    + " "
    + container.escapeExpression(((helper = (helper = lookupProperty(helpers,"pyLabelClass") || (depth0 != null ? lookupProperty(depth0,"pyLabelClass") : depth0)) != null ? helper : container.hooks.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : (container.nullContext || {}),{"name":"pyLabelClass","hash":{},"data":data,"loc":{"start":{"line":71,"column":66},"end":{"line":71,"column":82}}}) : helper)))
    + "\" for=\""
    + container.escapeExpression(((helper = (helper = lookupProperty(helpers,"pyForStrLabel") || (depth0 != null ? lookupProperty(depth0,"pyForStrLabel") : depth0)) != null ? helper : container.hooks.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : (container.nullContext || {}),{"name":"pyForStrLabel","hash":{},"data":data,"loc":{"start":{"line":71,"column":89},"end":{"line":71,"column":106}}}) : helper)))
    + "\"><input type=\"hidden\" name=\""
    + container.escapeExpression(((helper = (helper = lookupProperty(helpers,"pyParamName") || (depth0 != null ? lookupProperty(depth0,"pyParamName") : depth0)) != null ? helper : container.hooks.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : (container.nullContext || {}),{"name":"pyParamName","hash":{},"data":data,"loc":{"start":{"line":71,"column":135},"end":{"line":71,"column":150}}}) : helper)))
    + "\" value=\""
    + container.escapeExpression(((helper = (helper = lookupProperty(helpers,"pyParamValue") || (depth0 != null ? lookupProperty(depth0,"pyParamValue") : depth0)) != null ? helper : container.hooks.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : (container.nullContext || {}),{"name":"pyParamValue","hash":{},"data":data,"loc":{"start":{"line":71,"column":159},"end":{"line":71,"column":175}}}) : helper)))
    + "\">"
    + container.escapeExpression(((helper = (helper = lookupProperty(helpers,"pyLocalizedParamValue") || (depth0 != null ? lookupProperty(depth0,"pyLocalizedParamValue") : depth0)) != null ? helper : container.hooks.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : (container.nullContext || {}),{"name":"pyLocalizedParamValue","hash":{},"data":data,"loc":{"start":{"line":71,"column":177},"end":{"line":71,"column":202}}}) : helper)))
    + "</label>"
    + ((stack1 = lookupProperty(helpers,"if").call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? lookupProperty(depth0,"pyHelperLabel") : depth0),{"name":"if","hash":{},"fn":container.program(52, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":72,"column":6},"end":{"line":74,"column":24}}})) != null ? stack1 : "")
    + ((stack1 = lookupProperty(helpers,"if").call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? lookupProperty(depth0,"pyHelperLabelOnFocus") : depth0),{"name":"if","hash":{},"fn":container.program(63, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":75,"column":8},"end":{"line":83,"column":15}}})) != null ? stack1 : "");
},"60":function(container,depth0,helpers,partials,data) {
    var stack1, lookupProperty = container.lookupProperty || function(parent, propertyName) {
        if (Object.prototype.hasOwnProperty.call(parent, propertyName)) {
          return parent[propertyName];
  ...
  return ((stack1 = lookupProperty(helpers,"if").call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? lookupProperty(depth0,"pyHelperTextIconOnFocus") : depth0),{"name":"if","hash":{},"fn":container.program(61, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":68,"column":38},"end":{"line":70,"column":21}}})) != null ? stack1 : "");
  ...
  return "<div class=\""
    + ((stack1 = ((helper = (helper = lookupProperty(helpers,"pyLabelParentClass") || (depth0 != null ? lookupProperty(depth0,"pyLabelParentClass") : depth0)) != null ? helper : container.hooks.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : (container.nullContext || {}),{"name":"pyLabelParentClass","hash":{},"data":data,"loc":{"start":{"line":69,"column":28},"end":{"line":69,"column":52}}}) : helper))) != null ? stack1 : "")
    + "\" >";
  ...
  return ((stack1 = lookupProperty(helpers,"if").call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? lookupProperty(depth0,"pyHelperTextIconOnFocus") : depth0),{"name":"if","hash":{},"fn":container.program(64, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":76,"column":14},"end":{"line":82,"column":17}}})) != null ? stack1 : "");
  ...
  return "<span class=\"helper-icon-tooltip-parent\">\n                <i data-ctl=\"Icon\" class=\"icons pi pi-help pi-link helper-icon\" aria-label=\"help\" data-hover=\"[[&quot;showSmartTip&quot;,[&quot;:event&quot;,&quot;&quot;,&quot;"
    + container.escapeExpression(((helper = (helper = lookupProperty(helpers,"pyHelperVal") || (depth0 != null ? lookupProperty(depth0,"pyHelperVal") : depth0)) != null ? helper : container.hooks.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : (container.nullContext || {}),{"name":"pyHelperVal","hash":{},"data":data,"loc":{"start":{"line":78,"column":176},"end":{"line":78,"column":191}}}) : helper)))
    + "&quot;]]]\" data-click=\"[[&quot;showSmartTip&quot;,[&quot;:event&quot;,&quot;&quot;,&quot;"
    + container.escapeExpression(((helper = (helper = lookupProperty(helpers,"pyHelperVal") || (depth0 != null ? lookupProperty(depth0,"pyHelperVal") : depth0)) != null ? helper : container.hooks.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : (container.nullContext || {}),{"name":"pyHelperVal","hash":{},"data":data,"loc":{"start":{"line":78,"column":280},"end":{"line":78,"column":295}}}) : helper)))
    + "&quot;]]]\" onmouseover=\"pega.c.cbe.processHoverEvent(event)\" data-keydown=\"[[&quot;showSmartTip&quot;,[&quot;:event&quot;,&quot;&quot;,&quot;"
    + container.escapeExpression(((helper = (helper = lookupProperty(helpers,"pyHelperVal") || (depth0 != null ? lookupProperty(depth0,"pyHelperVal") : depth0)) != null ? helper : container.hooks.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : (container.nullContext || {}),{"name":"pyHelperVal","hash":{},"data":data,"loc":{"start":{"line":78,"column":436},"end":{"line":78,"column":451}}}) : helper)))
    + "&quot;],,&quot;enter&quot;]]\" tabindex=\""
    + container.escapeExpression(((helper = (helper = lookupProperty(helpers,"pyHelperTabIndex") || (depth0 != null ? lookupProperty(depth0,"pyHelperTabIndex") : depth0)) != null ? helper : container.hooks.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : (container.nullContext || {}),{"name":"pyHelperTabIndex","hash":{},"data":data,"loc":{"start":{"line":78,"column":491},"end":{"line":78,"column":511}}}) : helper)))
    + "\" role=\"button\" >\n                </i>\n              </span>\n              </div>";
  ...
  return ((stack1 = (lookupProperty(helpers,"ifCond")||(depth0 && lookupProperty(depth0,"ifCond"))||container.hooks.helperMissing).call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? lookupProperty(depth0,"pyFormat") : depth0),"==","pxRichTextEditor",{"name":"ifCond","hash":{},"fn":container.program(67, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":85,"column":10},"end":{"line":87,"column":36}}})) != null ? stack1 : "")
    + ((stack1 = lookupProperty(helpers,"if").call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? lookupProperty(depth0,"pyHelperLabelOnFocus") : depth0),{"name":"if","hash":{},"fn":container.program(70, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":88,"column":10},"end":{"line":92,"column":21}}})) != null ? stack1 : "")
    + "<label "
    + container.escapeExpression(((helper = (helper = lookupProperty(helpers,"pyAutomationID") || (depth0 != null ? lookupProperty(depth0,"pyAutomationID") : depth0)) != null ? helper : container.hooks.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : (container.nullContext || {}),{"name":"pyAutomationID","hash":{},"data":data,"loc":{"start":{"line":93,"column":17},"end":{"line":93,"column":35}}}) : helper)))
    + " class=\""
    + container.escapeExpression(((helper = (helper = lookupProperty(helpers,"pyLabelParentClass") || (depth0 != null ? lookupProperty(depth0,"pyLabelParentClass") : depth0)) != null ? helper : container.hooks.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : (container.nullContext || {}),{"name":"pyLabelParentClass","hash":{},"data":data,"loc":{"start":{"line":93,"column":43},"end":{"line":93,"column":65}}}) : helper)))
    + " "
    + container.escapeExpression(((helper = (helper = lookupProperty(helpers,"pyLabelClass") || (depth0 != null ? lookupProperty(depth0,"pyLabelClass") : depth0)) != null ? helper : container.hooks.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : (container.nullContext || {}),{"name":"pyLabelClass","hash":{},"data":data,"loc":{"start":{"line":93,"column":66},"end":{"line":93,"column":82}}}) : helper)))
    + ((stack1 = (lookupProperty(helpers,"ifCond")||(depth0 && lookupProperty(depth0,"ifCond"))||container.hooks.helperMissing).call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? lookupProperty(depth0,"pyIsChildNonTemplate") : depth0),"!=",true,{"name":"ifCond","hash":{},"fn":container.program(73, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":93,"column":82},"end":{"line":93,"column":213}}})) != null ? stack1 : "")
    + "\" for=\""
    + container.escapeExpression(((helper = (helper = lookupProperty(helpers,"pyForStrLabel") || (depth0 != null ? lookupProperty(depth0,"pyForStrLabel") : depth0)) != null ? helper : container.hooks.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : (container.nullContext || {}),{"name":"pyForStrLabel","hash":{},"data":data,"loc":{"start":{"line":93,"column":220},"end":{"line":93,"column":237}}}) : helper)))
    + "\""
    + ((stack1 = (lookupProperty(helpers,"ifCond")||(depth0 && lookupProperty(depth0,"ifCond"))||container.hooks.helperMissing).call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? lookupProperty(depth0,"pyIsChildNonTemplate") : depth0),"!=",true,{"name":"ifCond","hash":{},"fn":container.program(76, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":93,"column":239},"end":{"line":93,"column":338}}})) != null ? stack1 : "")
    + ">"
    + ((stack1 = (lookupProperty(helpers,"ifCond")||(depth0 && lookupProperty(depth0,"ifCond"))||container.hooks.helperMissing).call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? lookupProperty(depth0,"pyLabelValue") : depth0),"!=",".pyTemplateInputBox",{"name":"ifCond","hash":{},"fn":container.program(78, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":94,"column":10},"end":{"line":108,"column":23}}})) != null ? stack1 : "")
    + ((stack1 = lookupProperty(helpers,"if").call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? lookupProperty(depth0,"pyHelperLabel") : depth0),{"name":"if","hash":{},"fn":container.program(52, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":109,"column":6},"end":{"line":111,"column":24}}})) != null ? stack1 : "")
    + "</label>"
    + ((stack1 = (lookupProperty(helpers,"ifCond")||(depth0 && lookupProperty(depth0,"ifCond"))||container.hooks.helperMissing).call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? lookupProperty(depth0,"pyFormat") : depth0),"==","pxRichTextEditor",{"name":"ifCond","hash":{},"fn":container.program(81, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":113,"column":10},"end":{"line":116,"column":36}}})) != null ? stack1 : "")
    + ((stack1 = lookupProperty(helpers,"if").call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? lookupProperty(depth0,"pyHelperLabelOnFocus") : depth0),{"name":"if","hash":{},"fn":container.program(84, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":117,"column":10},"end":{"line":123,"column":30}}})) != null ? stack1 : "");
  ...
  return ((stack1 = (lookupProperty(helpers,"ifCond")||(depth0 && lookupProperty(depth0,"ifCond"))||container.hooks.helperMissing).call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? lookupProperty(depth0,"pyIsCellReadOnly") : depth0),"!=",true,{"name":"ifCond","hash":{},"fn":container.program(68, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":85,"column":56},"end":{"line":87,"column":23}}})) != null ? stack1 : "");
  ...
  return ((stack1 = lookupProperty(helpers,"if").call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? lookupProperty(depth0,"pyHelperTextIconOnFocus") : depth0),{"name":"if","hash":{},"fn":container.program(71, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":89,"column":14},"end":{"line":91,"column":23}}})) != null ? stack1 : "");
  ...
  return "<div class=\""
    + container.escapeExpression(((helper = (helper = lookupProperty(helpers,"pyLabelParentClass") || (depth0 != null ? lookupProperty(depth0,"pyLabelParentClass") : depth0)) != null ? helper : container.hooks.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : (container.nullContext || {}),{"name":"pyLabelParentClass","hash":{},"data":data,"loc":{"start":{"line":90,"column":30},"end":{"line":90,"column":52}}}) : helper)))
    + "\">";
  ...
  return ((stack1 = (lookupProperty(helpers,"ifCond")||(depth0 && lookupProperty(depth0,"ifCond"))||container.hooks.helperMissing).call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? lookupProperty(depth0,"IsCustomerRequiredFormat") : depth0),"==","false",{"name":"ifCond","hash":{},"fn":container.program(74, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":93,"column":127},"end":{"line":93,"column":202}}})) != null ? stack1 : "");
  ...
  return "data-required=\""
    + container.escapeExpression(((helper = (helper = lookupProperty(helpers,"pyCustomRequireFormat") || (depth0 != null ? lookupProperty(depth0,"pyCustomRequireFormat") : depth0)) != null ? helper : container.hooks.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : (container.nullContext || {}),{"name":"pyCustomRequireFormat","hash":{},"data":data,"loc":{"start":{"line":93,"column":300},"end":{"line":93,"column":325}}}) : helper)))
    + "\" ";
  ...
  return ((stack1 = (lookupProperty(helpers,"ifCond")||(depth0 && lookupProperty(depth0,"ifCond"))||container.hooks.helperMissing).call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? lookupProperty(depth0,"pyLabelValue") : depth0),"!=","",{"name":"ifCond","hash":{},"fn":container.program(79, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":95,"column":12},"end":{"line":107,"column":25}}})) != null ? stack1 : "");
  ...
  return ((stack1 = (lookupProperty(helpers,"ifCond")||(depth0 && lookupProperty(depth0,"ifCond"))||container.hooks.helperMissing).call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? lookupProperty(depth0,"pyIsCellReadOnly") : depth0),"!=",true,{"name":"ifCond","hash":{},"fn":container.program(82, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":113,"column":56},"end":{"line":116,"column":23}}})) != null ? stack1 : "");
},"82":function(container,depth0,helpers,partials,data) {
    return "<i data-ctl=\"Icon\" class=\"icons pi pi-keyboard\" title=\\\"Keyboard shortcuts\\\" onkeydown=\"pega.ui.RichTextEditor.prototype.showSmartInfoContent(event)\" onclick=\"pega.control.Actions.prototype.showSmartTip(event, '', window.rte_smartinfo_content, '');\" tabindex=\"0\" aria-label=\"Keyboard shortcuts\" role=\"button\"></i>\n           </div>";
  ...
  return ((stack1 = lookupProperty(helpers,"if").call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? lookupProperty(depth0,"pyHelperTextIconOnFocus") : depth0),{"name":"if","hash":{},"fn":container.program(85, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":117,"column":40},"end":{"line":123,"column":21}}})) != null ? stack1 : "");
  ...
  return "<span class=\"helper-icon-tooltip-parent\">\n                  <i data-ctl=\"Icon\" class=\"icons pi pi-help pi-link helper-icon\" aria-label=\"help\" data-hover=\"[[&quot;showSmartTip&quot;,[&quot;:event&quot;,&quot;&quot;,&quot;"
    + container.escapeExpression(((helper = (helper = lookupProperty(helpers,"pyHelperVal") || (depth0 != null ? lookupProperty(depth0,"pyHelperVal") : depth0)) != null ? helper : container.hooks.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : (container.nullContext || {}),{"name":"pyHelperVal","hash":{},"data":data,"loc":{"start":{"line":119,"column":178},"end":{"line":119,"column":193}}}) : helper)))
    + "&quot;]]]\" data-click=\"[[&quot;showSmartTip&quot;,[&quot;:event&quot;,&quot;&quot;,&quot;"
    + container.escapeExpression(((helper = (helper = lookupProperty(helpers,"pyHelperVal") || (depth0 != null ? lookupProperty(depth0,"pyHelperVal") : depth0)) != null ? helper : container.hooks.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : (container.nullContext || {}),{"name":"pyHelperVal","hash":{},"data":data,"loc":{"start":{"line":119,"column":282},"end":{"line":119,"column":297}}}) : helper)))
    + "&quot;]]]\" onmouseover=\"pega.c.cbe.processHoverEvent(event)\" data-keydown=\"[[&quot;showSmartTip&quot;,[&quot;:event&quot;,&quot;&quot;,&quot;"
    + container.escapeExpression(((helper = (helper = lookupProperty(helpers,"pyHelperVal") || (depth0 != null ? lookupProperty(depth0,"pyHelperVal") : depth0)) != null ? helper : container.hooks.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : (container.nullContext || {}),{"name":"pyHelperVal","hash":{},"data":data,"loc":{"start":{"line":119,"column":438},"end":{"line":119,"column":453}}}) : helper)))
    + "&quot;],,&quot;enter&quot;]]\" tabindex=\""
    + container.escapeExpression(((helper = (helper = lookupProperty(helpers,"pyHelperTabIndex") || (depth0 != null ? lookupProperty(depth0,"pyHelperTabIndex") : depth0)) != null ? helper : container.hooks.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : (container.nullContext || {}),{"name":"pyHelperTabIndex","hash":{},"data":data,"loc":{"start":{"line":119,"column":493},"end":{"line":119,"column":513}}}) : helper)))
    + "\" role=\"button\" >\n                  </i>\n                </span>\n                </div>";
  ...
  return ((stack1 = (lookupProperty(helpers,"ifCond")||(depth0 && lookupProperty(depth0,"ifCond"))||container.hooks.helperMissing).call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? lookupProperty(depth0,"pyLabelValue") : depth0),"!=","",{"name":"ifCond","hash":{},"fn":container.program(96, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":146,"column":4},"end":{"line":154,"column":17}}})) != null ? stack1 : "")
    + ((stack1 = (lookupProperty(helpers,"getDLCellControl")||(depth0 && lookupProperty(depth0,"getDLCellControl"))||container.hooks.helperMissing).call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? lookupProperty(depth0,"metaData") : depth0),{"name":"getDLCellControl","hash":{},"data":data,"loc":{"start":{"line":155,"column":8},"end":{"line":155,"column":41}}})) != null ? stack1 : "");
  ...
  return ((stack1 = lookupProperty(helpers,"if").call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? lookupProperty(depth0,"pyLabelReserveSpace") : depth0),{"name":"if","hash":{},"fn":container.program(97, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":147,"column":6},"end":{"line":153,"column":15}}})) != null ? stack1 : "");
  ...
  return ((stack1 = lookupProperty(helpers,"if").call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? lookupProperty(depth0,"pybParam") : depth0),{"name":"if","hash":{},"fn":container.program(98, data, 0),"inverse":container.program(100, data, 0),"data":data,"loc":{"start":{"line":148,"column":8},"end":{"line":152,"column":17}}})) != null ? stack1 : "");
  ...
  return "<label class=\""
    + container.escapeExpression(((helper = (helper = lookupProperty(helpers,"pyLabelParentClass") || (depth0 != null ? lookupProperty(depth0,"pyLabelParentClass") : depth0)) != null ? helper : container.hooks.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : (container.nullContext || {}),{"name":"pyLabelParentClass","hash":{},"data":data,"loc":{"start":{"line":149,"column":24},"end":{"line":149,"column":46}}}) : helper)))
    + " "
    + container.escapeExpression(((helper = (helper = lookupProperty(helpers,"pyLabelClass") || (depth0 != null ? lookupProperty(depth0,"pyLabelClass") : depth0)) != null ? helper : container.hooks.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : (container.nullContext || {}),{"name":"pyLabelClass","hash":{},"data":data,"loc":{"start":{"line":149,"column":47},"end":{"line":149,"column":63}}}) : helper)))
    + "\"><input type=\"hidden\" name=\""
    + container.escapeExpression(((helper = (helper = lookupProperty(helpers,"pyParamName") || (depth0 != null ? lookupProperty(depth0,"pyParamName") : depth0)) != null ? helper : container.hooks.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : (container.nullContext || {}),{"name":"pyParamName","hash":{},"data":data,"loc":{"start":{"line":149,"column":92},"end":{"line":149,"column":107}}}) : helper)))
    + "\" value=\""
    + container.escapeExpression(((helper = (helper = lookupProperty(helpers,"pyParamValue") || (depth0 != null ? lookupProperty(depth0,"pyParamValue") : depth0)) != null ? helper : container.hooks.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : (container.nullContext || {}),{"name":"pyParamValue","hash":{},"data":data,"loc":{"start":{"line":149,"column":116},"end":{"line":149,"column":132}}}) : helper)))
    + "\">"
    + container.escapeExpression(((helper = (helper = lookupProperty(helpers,"pyLocalizedParamValue") || (depth0 != null ? lookupProperty(depth0,"pyLocalizedParamValue") : depth0)) != null ? helper : container.hooks.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : (container.nullContext || {}),{"name":"pyLocalizedParamValue","hash":{},"data":data,"loc":{"start":{"line":149,"column":134},"end":{"line":149,"column":159}}}) : helper)))
    + "</label>";
  ...
  return "<label class=\""
    + container.escapeExpression(((helper = (helper = lookupProperty(helpers,"pyLabelParentClass") || (depth0 != null ? lookupProperty(depth0,"pyLabelParentClass") : depth0)) != null ? helper : container.hooks.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : (container.nullContext || {}),{"name":"pyLabelParentClass","hash":{},"data":data,"loc":{"start":{"line":151,"column":22},"end":{"line":151,"column":44}}}) : helper)))
    + " "
    + container.escapeExpression(((helper = (helper = lookupProperty(helpers,"pyLabelClass") || (depth0 != null ? lookupProperty(depth0,"pyLabelClass") : depth0)) != null ? helper : container.hooks.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : (container.nullContext || {}),{"name":"pyLabelClass","hash":{},"data":data,"loc":{"start":{"line":151,"column":45},"end":{"line":151,"column":61}}}) : helper)))
    + "\">"
    + ((stack1 = ((helper = (helper = lookupProperty(helpers,"pyLabelValue") || (depth0 != null ? lookupProperty(depth0,"pyLabelValue") : depth0)) != null ? helper : container.hooks.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : (container.nullContext || {}),{"name":"pyLabelValue","hash":{},"data":data,"loc":{"start":{"line":151,"column":63},"end":{"line":151,"column":81}}}) : helper))) != null ? stack1 : "")
    + "</label>";
  ...
  return "<span>"
    + ((stack1 = (lookupProperty(helpers,"getDLCellControl")||(depth0 && lookupProperty(depth0,"getDLCellControl"))||container.hooks.helperMissing).call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? lookupProperty(depth0,"metaData") : depth0),{"name":"getDLCellControl","hash":{},"data":data,"loc":{"start":{"line":161,"column":6},"end":{"line":161,"column":39}}})) != null ? stack1 : "")
    + "</span>";
},"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data) {
    var stack1, lookupProperty = container.lookupProperty || function(parent, propertyName) {
        if (Object.prototype.hasOwnProperty.call(parent, propertyName)) {
  ...
  return ((stack1 = (lookupProperty(helpers,"ifCond")||(depth0 && lookupProperty(depth0,"ifCond"))||container.hooks.helperMissing).call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? lookupProperty(depth0,"pyFormat") : depth0),"!=","pxHidden",{"name":"ifCond","hash":{},"fn":container.program(1, data, 0),"inverse":container.program(102, data, 0),"data":data,"loc":{"start":{"line":1,"column":0},"end":{"line":162,"column":13}}})) != null ? stack1 : "");
},"useData":true});
})();
...
pega.ui.template.DLTemplate = {
  ...
  isHelperIconOnFocus: function(node) {
        var TEMPLATE_CONSTANTS = pega.ui.TEMPLATE_CONSTANTS;
        var showHelperList = ["pxTextInput", "pxTextArea", "pxDropdown", "pxCheckbox", "pxAutoComplete", "pxDateTime", "pxMultiSelect","pxDateRange","pxAnyPicker","pxRadioButtons"];
        var showHelperIconOnfocus = false;
        /* Except for dropdown all other controls which support helper icon have helperType value at pyMode level Need to cater to both cases*/
        ...
        if (
          ...
          node.pyTemplates[0].pyCell &&
          ((node.pyTemplates[0].pyCell.pyModes[0] &&
            node.pyTemplates[0].pyCell.pyModes[0].helpertype == "icon_on_focus") ||
           node.pyTemplates[0].pyCell.helpertype == "icon_on_focus") &&
          showHelperList.indexOf(node.pyTemplates[0][TEMPLATE_CONSTANTS["PYNAME"]]) !=
          -1
        ) {
          showHelperIconOnfocus = true;
        } else if (node[TEMPLATE_CONSTANTS["PYVISIBILITY"]]) {
          if (
            node.pyTemplates &&
            node.pyTemplates[0] &&
            ...
            ((node.pyTemplates[0].pyTemplates[0].pyCell.pyModes[0] &&
              node.pyTemplates[0].pyTemplates[0].pyCell.pyModes[0].helpertype ==
              "icon_on_focus") ||
             node.pyTemplates[0].pyTemplates[0].pyCell.helpertype == "icon_on_focus") &&
            showHelperList.indexOf(
              node.pyTemplates[0].pyTemplates[0][TEMPLATE_CONSTANTS["PYNAME"]]
            ) != -1
          ) {
...
pega.ui.TemplateEngine.registerHelper("getDLCellControl", function(metaData, pyType) {
    ...
    if (childNode) {
        ...
        if (childTemplateName) {
            ...
            }else if(pega.ui.template.DLTemplate.isHelperIconOnFocus(metaData)){
              childNode.pyCell.pyHelperLabelOnFocus = false;
              if (metaData.pyCell && metaData.pyCell.pyLabelReserveSpace == "true" && metaData.pyCell.pyLabelValue) {
                childNode.pyCell.pyHelperLabelOnFocus = true;
              }
            }
...
pega.ui.template.RenderingEngine.register("DynamicLayoutCell", function(treeNode, fromReloadCell, asyncRenderCallback) {
  var TEMPLATE_CONSTANTS = pega.ui.TEMPLATE_CONSTANTS;
    ...
    if (controlName == "pxMultiSelect") {
        cellTemplateObj.pyForStrLabel = "ms"+ cellTemplateObj.pyForStrLabel;
    }
    cellTemplateObj.pyStrLabelForHelperText = currentContext.getID(cellTemplateObj.pyForStrLabel, "label", genUniqueId);
    ...
    cellTemplateObj.pyLabelParentClass = "field-caption";
    ...
    if (isChildReadOnly) {
        ...
        cellTemplateObj.pyLabelClass = cellTemplateObj.pyBaseLabelClassRead;
        ...
        cellTemplateObj.pyLabelClass = cellTemplateObj.pyBaseLabelClassWrite;
    ...
    if (cellTemplateObj.pyFlex && !cellTemplateObj.pyLabelReserveSpace && cellTemplateObj.pyType == "field") {
      ...
      if(node.pyTemplates && node.pyTemplates[0] && node.pyTemplates[0][TEMPLATE_CONSTANTS["PYNAME"]]) {
        var name = node.pyTemplates[0][TEMPLATE_CONSTANTS["PYNAME"]];
        name = (name != 'pxVisible') ? name : (node.pyTemplates[0].pyTemplates && node.pyTemplates[0].pyTemplates[0] && node.pyTemplates[0].pyTemplates[0][TEMPLATE_CONSTANTS["PYNAME"]]);
        if(name == "pxTextInput" || name == "pxTextArea" || name == "pxCheckbox" || name == "pxRadioButtons" || name == "pxDropdown" || name == "pxDateTime" || name == "pxAutoComplete" || name == "pxAnyPicker"){
            var cellNode = node.pyTemplates[0][TEMPLATE_CONSTANTS["PYNAME"]] != 'pxVisible' ? node.pyTemplates[0] : node.pyTemplates[0].pyTemplates[0];
            /* orientation should be horizontal */
    ...
    cellTemplateObj.pyHelperTextIconOnFocus = false;
    cellTemplateObj.pyHelperLabelOnFocus = false;
    var helperTextIconOnhover = pega.ui.template.DLTemplate.isHelperIcon(node);
    var helperTextIconOnFocus = pega.ui.template.DLTemplate.isHelperIconOnFocus(node);
    cellTemplateObj.pyHelperVal = "";
    if (helperTextIconOnhover|| helperTextIconOnFocus) {
        if(helperTextIconOnhover) {
            cellTemplateObj.pyHelperTextIcon = true;
            cellTemplateObj.pyHelperTabIndex = -1;
          }
          else {
            cellTemplateObj.pyHelperTextIconOnFocus = true;
            cellTemplateObj.pyHelperTabIndex = 0;
          }
        ...
        if (node[TEMPLATE_CONSTANTS["PYVISIBILITY"]]) {
          toolTipVal =
            ...
            node.pyTemplates[0].pyTemplates[0] &&
            node.pyTemplates[0].pyTemplates[0].pyCell &&
            (node.pyTemplates[0].pyTemplates[0].pyCell.tooltip ||
            ((node.pyTemplates[0].pyTemplates[0].pyCell.pyModes &&
            node.pyTemplates[0].pyTemplates[0].pyCell.pyModes[0]) &&
            (node.pyTemplates[0].pyTemplates[0].pyCell.pyModes[0].tooltip || node.pyTemplates[0].pyTemplates[0].pyCell.pyModes[0].helperTextRadiogroup)));
          if(!toolTipVal){
            toolTipVal = node.pyTemplates &&
                      node.pyTemplates[0] &&
                      node.pyTemplates[0].pyCell &&
                      node.pyTemplates[0].pyCell.pyModes &&
                      node.pyTemplates[0].pyCell.pyModes[0] &&
          ...
          toolTipVal =
            ...
            ? helperText
            : node.pyTemplates[0].pyCell.tooltip || node.pyTemplates[0].pyCell.pyModes[0].tooltip;
        }
        if (toolTipVal) {
            var _pyTooltip;
            ...
            else if(pyName === "pxDateTime" || pyName === "pxDateRange" || (pyName === 'pxVisible' && node &&  node.pyTemplates && node.pyTemplates[0] && node.pyTemplates[0].pyTemplates && node.pyTemplates[0].pyTemplates[0] && (node.pyTemplates[0].pyTemplates[0][TEMPLATE_CONSTANTS["PYNAME"]] === "pxDateTime" || node.pyTemplates[0].pyTemplates[0][TEMPLATE_CONSTANTS["PYNAME"]] === "pxDateRange"))) _pyTooltip = currentContext.getLocalizedValue(toolTipVal, "pyCaption", "");
            else _pyTooltip = currentContext.getLocalizedValue(toolTipVal, "pyTooltip", "");
            //BUG-661561: _pyTooltip can be empty string if tooltip configured for property having empty value.
            if (!_pyTooltip  && _pyTooltip !== "") { /* constant values will not get localized values for currentContext */
        ...
        if (cellTemplateObj.pyLabelReserveSpace && cellTemplateObj.pyLabelValue && helperTextIconOnhover) {
              cellTemplateObj.pyHelperLabel = true;
        } else if(cellTemplateObj.pyLabelReserveSpace && cellTemplateObj.pyLabelValue && helperTextIconOnFocus){
            cellTemplateObj.pyHelperLabelOnFocus = true;
        }
  
      if (!cellTemplateObj.pyHelperLabel && !cellTemplateObj.pyHelperLabelOnFocus) {
