...
/* does nothing*/
pega.p.openUserDashboard = function(userId,tabName){
/* TODO : your customization code here */
};



/* to open profile in popup */
/*
pega.p.openUserDashboard = function(userId,tabName){
  var options = {
  harness: "pyUserDashboard",
  harnessClass: "Data-Admin-Operator-ID" ,
  ...
  readOnly: true,
  doSubmit: true,
  activity: {name: "pzSetUserProfile", parameters: [{name: "UserID", value: userId, isProperty: false}]},
  displayHarnessFromServer: true,
  event: event
  };
...
This version of markJS is not released, yet. It's been taken directly from https://github.com/julmot/mark.js/, 3rd of Dec,2018
*****************************************************/
...
(function ($, _, undefined) {
  ...
  var defaultSettings = {
    ...
    classes: {
      ...
      autoCompleteCategoryActive: "active",
    },
    templates: {
      wrapper: _.template('<div class="mentions-input-box"></div>'),
      autocompleteList: _.template('<div class="mentions-autocomplete-list"></div>'),
      autocompleteListItem: _.template(
        '<li data-ref-id="<%= id %>" data-ref-type="<%= type %>" data-display="<%= display %>"><div class="ellipsesM" >' +
          (pega.u.d.isOrientationRTL()
            ? '<span class="userid" style=""> <%=value%></span>@ <span class="name" style=""><%= display %></span>'
            : '<span class="name" style=""><%= display %></span><span class="userid" style=""> @<%=value%></span>') +
          "</div>" +
          (pega.u.d.isOrientationRTL()
            ? '<div class="additionalInfoRT ellipsesM" style=""><%=additionalInfo%></div>'
            : '<div class="additionalInfoLT ellipsesM"   style=""><%=additionalInfo%></div>') +
          "</li>"
      ),
      autocompleteListItemNoAddInfo: _.template(
        '<li data-ref-id="<%= id %>" data-ref-type="<%= type %>" data-display="<%= display %>"><div class="ellipsesM noAdditionalInfo"  >' +
          (pega.u.d.isOrientationRTL()
            ? '<span class="userid" style=""> <%=value%></span>@ <span class="name" style=""><%= display %></span>'
            : '<span class="name" style=""><%= display %></span><span class="userid" style=""> @<%=value%></span>') +
          "</div>"
      ),
      autocompleteListItemForCases: _.template(
        '<li data-ref-id="<%= id %>" data-ref-type="<%= type %>" data-display="<%= display %>"><div class="ellipsesM" >' +
          (pega.u.d.isOrientationRTL()
            ? '<span class="name" style="" title="<%= display %>"> <%=display%></span>'
            : '<span class="name" style="" title="<%= display %>"> <%=display%></span>') +
          "</div>" +
          (pega.u.d.isOrientationRTL()
            ? '<div class="additionalInfoRT ellipsesM" > <span class="" style=""><%= value %> | </span><%=additionalInfo%></div>'
            : '<div class="additionalInfoLT ellipsesM" style=""> <span class="" style=""><%= value %> | </span><%=additionalInfo%></div>') +
          "</li>"
      ),
      autocompleteListItemForCasesNoAddInfo: _.template(
        '<li data-ref-id="<%= id %>" data-ref-type="<%= type %>" data-display="<%= display %>"><div class="ellipsesM" >' +
          (pega.u.d.isOrientationRTL()
            ? '<span class="name" style="" title="<%= display %>"> <%=display%></span>'
            : '<span class="name" style="" title="<%= display %>"> <%=display%></span>') +
          "</div>" +
          (pega.u.d.isOrientationRTL()
            ? '<div class="additionalInfoRT ellipsesM" > <span class="" style=""><%= value %></span></div>'
            : '<div class="additionalInfoLT ellipsesM" style=""> <span class="" style=""><%= value %></span></div>') +
          "</li>"
      ),
      autocompleteListItemForTags: _.template(
        '<li class="mentions-tag-item" data-ref-id="<%= id %>" data-ref-type="<%= type %>" data-display="<%= display %>"><span >#<%=value%></span></li>'
      ),
      autocompleteListItemAvatar: _.template(
        '<img src="<%= avatar %>" style="object-fit:cover;float: ' +
          (pega.u.d.isOrientationRTL() ? "right;" : "left;") +
          ';" onerror="this.src=' +
          "'./webwb/desktopimages/pzdefaultUserPic.png'" +
          '"/>'
      ),
      autocompleteListItemCaseIcon: _.template(
        '<div ><img src="<%= avatar %>" class="<%=iconClass%> "  style="object-fit:cover;float: ' +
          (pega.u.d.isOrientationRTL() ? "right;" : "left;") +
          ';" / ></div>'
      ),

      autocompleteListItemInitial: _.template(
        '<div><i class="icons avatar name-<%= initialClass %>" style="width: 30px; height: 30px; float: ' +
          (pega.u.d.isOrientationRTL() ? "right;" : "left;") +
          ';  margin-top: 5px; margin-right: 5px;"><svg viewBox="0 0 100 100" pointer-events="none" xmlns="http://www.w3.org/2000/svg"><circle cx="50" cy="50" r="50" fill="purple"/><text x="50%" y="65%" transform="scale(1, 1)" text-anchor="middle" fill="white" font-size="12"><%= initials %></text></svg></i></div>'
      ),
      autocompleteListItemIcon: _.template('<div  class="divIcon <%= icon %>"></div>'),
      mentionsOverlay: _.template('<div class="mentions"><div></div></div>'),
      mentionItemSyntax: _.template("@[<%= value %>](<%= type %>:<%= id %>)"),
      mentionItemHighlight: _.template("<strong><span><%= value %></span></strong>"),

      autocompleteHeader: _.template(
        '<div style="font-family: OpenSans,sans-serif;font-size: 14px;padding:2px 12px;padding-left:5px;padding-bottom:5px;border-bottom: 1px solid #D3D3D3; "><%= headerText%></div>'
      ),
      autocompleteCategoryListItem: _.template(
        '<li data-ref-id="<%= value %>" style="padding:0px;" class="mcategory">  <div class="selectMentionType" style="line-height:30px;" id="<%=value%>"><span id="type"> <%=display%></span></div></li>'
      ),

      autocompleteTagListItem: _.template(
        '<li class="mentions-tag-item" title="<%= id %>" data-ref-id="<%= id %>" data-ref-type="<%= type %>" style="">#<%=value%></li>'
      ),
      autocompleteTagListHeader: _.template('<div  class="mentions-tag-header" style=""><%=headerText%></div>'),
      autocompleteTagListWrapper: _.template('<div id="mentions-tag-wrapper" class="mentions-tag-wrapper"></div>'),
    },
  };
  ...
  var utils = {
    ...
    setCaratPosition: function (domNode, caretPos) {
      if (domNode.createTextRange) {
        ...
        // added (domNode.selectionStart === 0) for edge browser support
        if (domNode.selectionStart || domNode.selectionStart === 0) {
          domNode.focus();
    ...
    getCaratPosition: function (input) {
      var inputWithSapces = input.value;
      var leadingSpaceCount = input.value.length - inputWithSapces.replace(/^\s+/, "").length;

      if ("selectionStart" in input && document.activeElement == input) {
        return input.selectionStart - leadingSpaceCount;
        ...
        if (sel.parentElement() === input) {
          ...
          for (var pos = 0; rng.compareEndPoints("EndToStart", rng) > 0; rng.moveEnd("character", -1)) {
            pos++;
          }
          return pos - leadingSpaceCount;
        }
      }
      return -1;
    },
  ...
  var MentionsInput = function (settings) {
    var domInput,
      ...
      noOfElementsShown,
      mentionType = "",
      mentionsHeaderText = "Mention",
      noOfItemsToDisplay = 10,
      mentionItemTemplate = "",
      oldTextValue = "",
      currentDataQuery = "",
      isMentionsRequestReq = true,
      lastPositionWithResults;
    ...
    function initTextarea() {
      ...
      // Wrapping mentions input div around span of textarea to support resizing
      if (elmInputBox.is("textarea")) {
        elmInputWrapper = elmInputBox.parent().parent().parent(); //Get the DOM element parent
        elmInputBox.parent().parent().wrapAll(elmWrapperBox);
      } else {
      ...
      // check if the user's device is Android running on Chrome
      var navUserAgent = navigator.userAgent;
      if (navUserAgent.match(/Android/i)) {
        // && navUserAgent.match(/Chrome\/([\d.]+)/)){
        elmInputBox.bind("keyup", onInputBoxKeyUp); //Bind the keypress event to the text area
      } else {
    ...
    function initAutocomplete() {
      elmAutocompleteList = $(settings.templates.autocompleteList({ top: "margin-top:0px" })); //Get the HTML code for the list
      elmAutocompleteList.appendTo(elmWrapperBox); //Append to elmWrapperBox element

      if (pega.cl && pega.cl.isTouchAble()) {
        elmAutocompleteList.on("touchstart", "li", onAutoCompleteItemClick); //Delegate the event
        elmAutocompleteList.on("mousedown", "li", onAutoCompleteItemClick);
      } else {
        elmAutocompleteList.on("mousedown", "li", onAutoCompleteItemClick); //Delegate the event
      }
    }
    ...
    function addMention(mention) {
      ...
      if (caretPosition > 1) {
        regex.lastIndex = caretPosition;
      }

      // BUG-525346 --> to avoid startCaretPosition value to become -1
      ...
      var startEndIndex = (start + mention.value).length + 2;

      // See if there's the same mention in the list
      if (
        !_.find(mentionsCollection, function (object) {
          return object.value == mention.value;
        })
      ) {
      ...
      // added code to fix the issue of not able to select operators when just @ is typed
      if (currentMessage == "@" || currentMessage == "#") {
        actualTrigger = currentMessage;
        end = "";
      } else {
         if (currentMessage[startCaretPosition].indexOf("@") === 0) {
             actualTrigger = "@";
         } else {
             actualTrigger = "#";
         }
      }
      //var updatedMessageText = start +actualTrigger+ mention.value + ' ' + end;
      if (mention.value.indexOf(" ") == -1 && actualTrigger == "#") {
        var updatedMessageText = start + " " + actualTrigger + mention.value + " " + end;
      } else if (mention.value.indexOf(" ") == -1) {
        var updatedMessageText = start + actualTrigger + mention.value + " " + end;
      } else {
        var updatedMessageText = start + "<" + actualTrigger + mention.value + ">" + " " + end;
        startEndIndex = startEndIndex + 2;
      }
      elmInputBox.val(updatedMessageText); //Set the value to the txt area
      oldTextValue = updatedMessageText; //This is required for android
    ...
    function onAutoCompleteItemClick(e) {
      ...
      var postText = getInputBoxValue();
      postText = postText.substring(0, elmInputBox[0].selectionStart);
      var forTags = !(postText.lastIndexOf("@") > postText.lastIndexOf("#"));

      var mention = autocompleteItemCollection[elmTarget.attr("data-uid")]; //Obtains the mention
      if (!forTags && currentDataQuery == "") {
    ...
    function onInputBoxClick(e) {
      //In mobile, if user hiding keyboard to select item and then starts typing it is restiing buffer. Added check to ignore resetting in such scenario
      if (!$("html").hasClass("phone")) resetBuffer();
    }
    ...
    function checkTriggerChar(inputBuffer, triggerChar) {
      var triggerCharIndex = _.lastIndexOf(inputBuffer, triggerChar); //Returns the last match of the triggerChar in the inputBuffer
      if (triggerCharIndex > -1) {
        //If the triggerChar is present in the inputBuffer array
        settings.isTriggerCharFound = true;
        var currentMessage = getInputBoxValue();
        var storePrevChar = previousChar;
        var previousChar = currentMessage.substring(caretPosition - 2, caretPosition - 1);
        var nextChar = currentMessage.substring(caretPosition, caretPosition + 1);
        var ignoreNextChar = false;

        var isPreviousCharTrigger = false;
        if (_.isArray(settings.triggerChar)) {
          settings.triggerChar.some(function (trigChar) {
            if (previousChar == trigChar) {
              isPreviousCharTrigger = true;
              return true;
            }
          });
        } else {
          if (previousChar == settings.triggerChar) isPreviousCharTrigger = true;
        }

        // BUG-327570 check if the triggerChar is being inserted before a word..
        if (!Boolean(isPreviousCharTrigger) && nextChar !== "," && nextChar !== " " && nextChar !== "") {
          var nextWord = currentMessage.substring(caretPosition).split(" ")[0];
          ignoreNextChar = nextWord.length > 0 ? true : false;
        }

        //If the previous char is , or " " then only trigger
        if (
          isPreviousCharTrigger == true ||
          previousChar == "," ||
          previousChar == " " ||
          ...
          previousChar = inputBuffer[triggerCharIndex - 1];
          //To handle the operators with @ in the id
          if (
            previousChar &&
            previousChar != "," &&
            previousChar != " " &&
            ...
            newTriggerCharIndex = _.lastIndexOf(inputBuffer, triggerChar, triggerCharIndex - 1);
            // ignore the trigger when there was no @ in the starting of the word BUG-243005
            if (newTriggerCharIndex == -1) return true;
            currentDataQuery = inputBuffer.slice(newTriggerCharIndex + 1).join(""); //Gets the currentDataQuery
          } else {
            currentDataQuery = inputBuffer.slice(triggerCharIndex + 1).join(""); //Gets the currentDataQuery

            var isPresent = currentDataQuery.indexOf("#");
            if (isPresent > 0) {
              currentDataQuery = currentDataQuery.slice(isPresent);
              return;
            }

            if (currentDataQuery == "") {
              isMentionsRequestReq = true;
              lastPositionWithResults = 0;
            }

            if (storePrevChar == "@" && currentDataQuery != "") {
              isMentionsRequestReq = true;
              lastPositionWithResults = 0;
            } else if (storePrevChar == "#" && currentDataQuery != "") {
              mentionType = "";
              isMentionsRequestReq = true;
              lastPositionWithResults = 0;
            }
          ...
          // BUG-244022 : prevents doSearch when @space is typed by user, thus prevents recents to be added twice
          if (currentDataQuery == " ") {
            hideAutoComplete();
            return;
          }

          //Need to che3ck white spaces,so removing trimming
          //currentDataQuery = utils.rtrim(currentDataQuery); //Deletes the whitespaces
          _.defer(_.bind(doSearch, this, currentDataQuery, mentionType)); //Invoking the function doSearch ( Bind the function to this)
        }
      }
    }
    ...
    function onInputBoxInput(e) {
      //BUG-635770 - Loading issue of operator names in pulse post. 
      if (e.originalEvent.inputType === "insertFromPaste") {
        inputBuffer.push(elmInputBox.val().split("@").pop());
      }
      //if user do ctrl a and deleted the text reset the buffer and return
      if (getInputBoxValue() == "") {
        resetBuffer();
        hideAutoComplete();
        resetMentionType();
      ...
      caretPosition = utils.getCaratPosition(e.target);
      settings.isTriggerCharFound = false;
      if (_.isArray(settings.triggerChar)) {
      ...
      if (settings.isTriggerCharFound == false) {
        hideAutoComplete();
        resetMentionType();
      }
    }
    ...
    /*
      2017155 changes for BUG-331554
      Takes the keyup event, we are firing onInputBoxInput() after the diff of chars coz the order of calling of events is 
      KeyPress -> KeyDown -> onInputBoxInput -> KeyUp
      But keypress is deprecated on Android, KeyDown gives inconsistent results wrt the current value of the input. 
      Hence chose KeyUp event to find the diff of chars and update the input buffer accordingly.
      */
    function onInputBoxKeyUp(e) {
      var oldValue = oldTextValue;
      var inputValue = this.value;
      // assign new value to data-old attribute
      oldTextValue = inputValue;

      if (oldValue !== undefined) {
        // check if chars are removed..
        var removedChars = findCharsRemovedOrInserted(oldValue, inputValue);
        if (removedChars !== "") {
          // chars removed ==> update the input buffer and re-calculate the carat positions
          inputBuffer = inputBuffer.slice(0, -1 + inputBuffer.length); // Can't use splice, not available in IE
          onInputBoxInput(e);
        } else {
          // check for inserted chars
          var insertedChar = findCharsRemovedOrInserted(inputValue, oldValue);
          if (insertedChar !== "") {
            // after selection of mentions suggestion, insertedChar gets populated with the selected mention. In such cases buffer isn't handling @ properly
            if (insertedChar.length > 1 && insertedChar.lastIndexOf("@") !== -1) inputBuffer.push("@");
            else inputBuffer.push(insertedChar); //Push the value pressed into inputBuffer
            onInputBoxInput(e);
          }
        }
      }
      // old value is undefined for the first character.. so push the first character to inputbuffer.
      else {
        inputBuffer.push(inputValue);
        onInputBoxInput(e);
      }
    }

    // find inserted/removed characters
    function findCharsRemovedOrInserted(inputValue, prevValue) {
      var diffOfChars = "";
      for (var i = 0; i < inputValue.length; i++) {
        var str = inputValue.substr(0, i) + inputValue.substr(i + inputValue.length - prevValue.length);

        if (str == prevValue) diffOfChars = inputValue.substr(i, inputValue.length - prevValue.length);
      }
      return diffOfChars;
    }
    ...
    function onInputBoxKeyPress(e) {
      if (e.keyCode == KEY.TRIGGERCHAR && (inputBuffer.length == 0 || inputBuffer[inputBuffer.length - 1] == " ")) {
        resetMentionType();
      }

      if (e.keyCode !== KEY.BACKSPACE) {
        //If the key pressed is not the backspace
        var typedValue = String.fromCharCode(e.which || e.keyCode); //Takes the string that represent this CharCode
        inputBuffer.push(typedValue); //Push the value pressed into inputBuffer
      }
    }
    //Checks if passed char is trigger char
    function isTriggerChar(inputChar) {
      var isTriggerCharFound = false;
      if (_.isArray(settings.triggerChar)) {
        settings.triggerChar.some(function (trigChar) {
          if (inputChar == trigChar) {
            isTriggerCharFound = true;
            return true;
          }
        });
      } else {
        if (inputChar == settings.triggerChar) {
          isTriggerCharFound = true;
          return true;
        }
      }
      return isTriggerCharFound;
    }
    ...
    function onInputBoxKeyDown(e) {
      ...
      if (e.keyCode === KEY.BACKSPACE) {
        //Resets the lastposition if complete text along with triggerchar is removed
        var inputLength = inputBuffer.length;
        if (inputLength > 0 && isTriggerChar(inputBuffer[inputLength - 1])) {
          if (inputLength > 1) {
            var previousToTriggerChar = inputBuffer[inputLength - 2];
            if (
              previousToTriggerChar != "," &&
              previousToTriggerChar != " " &&
              previousToTriggerChar != "\r" &&
              previousToTriggerChar != "\n"
            ) {
              //Do not reset as triggerchar is part of search text
            } else {
              lastPositionWithResults = 0;
            }
          } else {
        ...
        inputBuffer = inputBuffer.slice(0, -1 + inputBuffer.length); // Can't use splice, not available in IE
        if (lastPositionWithResults && inputBuffer.length <= lastPositionWithResults) {
          isMentionsRequestReq = true;
        } else {
          isMentionsRequestReq = false;
        }
        return;
      }
        ...
        case KEY.RIGHT:
          ...
          if (e.keyCode === KEY.DOWN || e.keyCode === KEY.RIGHT) {
            ...
            if (elmActiveAutoCompleteItem && elmActiveAutoCompleteItem.length) {
              //If elmActiveAutoCompleteItem exits
              elmCurrentAutoCompleteItem = elmActiveAutoCompleteItem.next("li"); //Gets the next li element in the list

              //To handle suggested and recent tags
              if (
                elmCurrentAutoCompleteItem.length === 0 &&
                elmActiveAutoCompleteItem.parent().hasClass("mentions-tag-wrapper")
              ) {
                elmCurrentAutoCompleteItem = elmActiveAutoCompleteItem
                  .parent()
                  .nextAll("div.mentions-tag-wrapper")
                  .find("li")
                  .first();
              }
            } else {
            ...
            elmCurrentAutoCompleteItem = $(elmActiveAutoCompleteItem).prev("li"); //The key pressed was UP and gets the previous li element
            //To handle suggested and recent tags
            if (
              elmCurrentAutoCompleteItem.length === 0 &&
              elmActiveAutoCompleteItem.parent().hasClass("mentions-tag-wrapper")
              ...
              elmCurrentAutoCompleteItem = elmActiveAutoCompleteItem
                .parent()
                .prevAll("div.mentions-tag-wrapper")
                .find("li")
                .last();
            }
          }
          if (elmCurrentAutoCompleteItem.length) {
            if (elmActiveAutoCompleteItem) {
              elmActiveAutoCompleteItem.removeClass(settings.classes.autoCompleteCategoryActive);
            }
            selectAutoCompleteItem(elmCurrentAutoCompleteItem);
          }
          return false;
        case KEY.RETURN: //If the key pressed was RETURN or TAB
          //If enter key is triggered, clear action sequenece for reply input
          if ($(elmInputBox).prop("tagName") == "INPUT") {
            pega.p.clearReplyAction = true;
          }
        case KEY.TAB:
          if (elmActiveAutoCompleteItem && elmActiveAutoCompleteItem.length) {
            //If the elmActiveAutoCompleteItem exists
    ...
    function setMentionType(mention) {
      if (mention) {
        mentionType = mention.className;
        mentionsHeaderText = mention.mentionsHeader;
        mentionItemTemplate = mention.mentionItemTemplate;

        if (mention.noOfItemsToDisplay && mention.noOfItemsToDisplay != "") {
          noOfItemsToDisplay = mention.noOfItemsToDisplay;
        }
      }
    }
    ...
    function selectAutoCompleteItem(elmItem) {
      if (currentDataQuery == "") {
        elmItem.addClass(settings.classes.autoCompleteCategoryActive); //Add the class active to item
        elmItem.siblings().removeClass(settings.classes.autoCompleteCategoryActive); //Gets all li elements in autocomplete list and remove the class active

        var mention = autocompleteItemCollection[$(elmItem).attr("data-uid")]; //Obtains the mention
        //Handling mentionType selection
        setMentionType(mention);
      } else {
    ...
    /*Utility function to form UI for tags */
    function populateTagsList(resultsList, headerText, elmDropDownList, selectItem) {
      //Create header for suggested tags
      var autoCompleteTagHeader = $(
        settings.templates.autocompleteTagListHeader({
          headerText: utils.htmlEncode(headerText),
        })
      );
      autoCompleteTagHeader.appendTo(elmDropDownList);

      var autoCompleteTagWrapper = $(settings.templates.autocompleteTagListWrapper());
      autoCompleteTagWrapper = autoCompleteTagWrapper.appendTo(elmDropDownList);

      /*Iterate through suggested list and show the suggested list*/
      _.each(resultsList, function (item, index) {
        if (index > 10) {
          return;
        }
        ...
        var elmListItem = $(
          settings.templates.autocompleteTagListItem({
            id: utils.htmlEncode(item.name),
            type: utils.htmlEncode(item.name),
            value: utils.htmlEncode(item.value),
          })
        ...
        elmListItem = elmListItem.appendTo(autoCompleteTagWrapper);
      });
    }

    /*Populates suggested and recent tags when user types #*/
    function populateSuggestedAndRecentTagsList(results, elmDropDownList) {
      var selectItem = true;
      if (results.suggestedTags && results.suggestedTags.resultsList.length > 0) {
        populateTagsList(
          results.suggestedTags.resultsList,
          results.suggestedTags.HeaderText,
          elmDropDownList,
          selectItem
        );
        selectItem = false;
      }
      if (results.recentTags && results.recentTags.resultsList.length > 0) {
        populateTagsList(results.recentTags.resultsList, results.recentTags.HeaderText, elmDropDownList, selectItem);
      }
    }
    ...
    function populateDropdown(query, results) {
      ...
      var postText = getInputBoxValue();
      postText = postText.substring(0, elmInputBox[0].selectionStart);
      //var forTags = !(getInputBoxValue().lastIndexOf("@")>getInputBoxValue().lastIndexOf("#"));
      var forTags = !(postText.lastIndexOf("@") > postText.lastIndexOf("#"));
      if (!settings.allowRepeat) {
        // Filter items that has already been mentioned
        var mentionValues = _.map(mentionsCollection, "value");
        results = _.reject(results, function (item) {
          return _.includes(mentionValues, item.value);
        });
      }
      ...
      if (!results || (_.isArray(results) && !results.length) || postText == "") {
        //If there are not elements hide the autocomplete list
        hideAutoComplete();
        return;
      }
      ...
      if (!forTags) {
        if (query != "") {
          var autoCompleteHeader = $(
            settings.templates.autocompleteHeader({
              headerText: utils.htmlEncode(mentionsHeaderText),
            })
          );
          autoCompleteHeader.appendTo(elmDropDownList);
        }
      }
      noOfElementsShown = 0;

      //Getting no of items to display based on configurations
      var noOfItemsToShow = settings.noOfUsersToShow;
      var autocompleteItemTemplate = "";
      //For no of items to display
      if (query != "") {
        if (noOfItemsToDisplay && noOfItemsToDisplay != "") {
          noOfItemsToShow = noOfItemsToDisplay;
        }
        if (mentionItemTemplate && mentionItemTemplate != "") {
          autocompleteItemTemplate = mentionItemTemplate;
        }
      }
      if (forTags && query == "") {
        populateSuggestedAndRecentTagsList(results, elmDropDownList);
      } else {
        _.each(results, function (item, index) {
          //Limiting list to user defined settings
          if (index < noOfItemsToShow) {
            noOfElementsShown = noOfElementsShown + 1;
            var itemUid = _.uniqueId("mention_"); //Gets the item with unique id
            ...
            if (!forTags) {
              if (query == "") {
                /*BUG-561758 validating class name to make sure invalid results are not showhn when query is blank*/
                if (!item.className || item.className == "") {
                  return;
                }

                var elmListItem = $(
                  settings.templates.autocompleteCategoryListItem({
                    display: utils.htmlEncode(item.name),
                    value: utils.htmlEncode(item.value),
                    iconClass: utils.htmlEncode(item.iconClass),
                    className: utils.htmlEncode(item.className),
                  })
                ).attr("data-uid", itemUid); //Inserts the new item to list
              } else if (autocompleteItemTemplate == "autocompleteListItemForCases") {
                var elmListItem = $(
                  settings.templates.autocompleteListItemForCases({
                    id: utils.htmlEncode(item.id),
                    display: utils.htmlEncode(item.name),
                    type: utils.htmlEncode(item.type),
                    value: utils.htmlEncode(item.value),
                    additionalInfo: utils.htmlEncode(item.AdditionalInfo),
                    content: utils.highlightTerm(utils.htmlEncode(item.display ? item.display : item.name), query),
                  })
                ).attr("data-uid", itemUid); //Inserts the new item to list
              } else if (autocompleteItemTemplate == "autocompleteListItemForCasesNoAddInfo") {
                var elmListItem = $(
                  settings.templates.autocompleteListItemForCasesNoAddInfo({
                    id: utils.htmlEncode(item.id),
                    display: utils.htmlEncode(item.name),
                    type: utils.htmlEncode(item.type),
                    value: utils.htmlEncode(item.value),
                ...
                if (item.AdditionalInfo != "") {
                  ...
                  var elmListItem = $(
                    settings.templates.autocompleteListItemNoAddInfo({
                      id: utils.htmlEncode(item.id),
                      display: utils.htmlEncode(item.name),
                      type: utils.htmlEncode(item.type),
                      value: utils.htmlEncode(item.value),
              ...
              var elmListItem = $(
                settings.templates.autocompleteListItemForTags({
                  id: utils.htmlEncode(item.id),
                  display: utils.htmlEncode(item.name),
                  type: utils.htmlEncode(item.type),
                  value: utils.htmlEncode(item.value),
            ...
            if (query == "") {
              if ((mentionType == "" && item.isDefault == "true") || mentionType == item.className) {
                selectAutoCompleteItem(elmListItem);
              }
            }
            ...
            if (!forTags && settings.showAvatars) {
              var elmIcon;

              //If the item has an avatar
              if (item.avatar && item.avatar != "") {
                // If user doesnt have a profile image, show user initials as profile image
                if (item.avatar === "./webwb/desktopimages/pzdefaultUserPic.png" && item.name != "") {
                  // Get username first letter for profile image style class
                  var usernameClass = item.name.charAt(0).toLowerCase().match(/[a-z]/);
                  if (usernameClass == null) {
                    usernameClass = "x";
                  }

                  // Get username first initials for profile image label
                  var usernameLbl = item.name.toUpperCase().charAt(0);
                  var lnIdx = item.name.lastIndexOf(" ");
                  if (lnIdx != -1) {
                    usernameLbl += item.name.toUpperCase().charAt(lnIdx + 1);
                  }

                  elmIcon = $(
                    settings.templates.autocompleteListItemInitial({
                      initialClass: usernameClass,
                      initials: usernameLbl,
                    })
                  );
                } else {
                  if (
                    autocompleteItemTemplate == "autocompleteListItemForCases" ||
                    autocompleteItemTemplate == "autocompleteListItemForCasesNoAddInfo"
                  ) {
                    elmIcon = $(
                      settings.templates.autocompleteListItemCaseIcon({
                        avatar: item.avatar,
                ...
                //If not then we set an default icon
                elmIcon = $(settings.templates.autocompleteListItemIcon({ icon: item.iconClass }));
              }
      ...
      if (settings.onCaret) {
        positionAutocomplete(elmAutocompleteList, elmInputBox, query);
        //elmAutocompleteList[0].style.marginTop  =  (20-elmInputBox[0].offsetHeight) + "px";
      }
      elmDropDownList.show(); //Shows the elmDropdownlist
    }

    //Search into data list passed as parameter
    function doSearch(query, mentionType) {
      //Sends request only if previous search has given results
      if (isMentionsRequestReq) {
        //Call the onDataRequest function and then call the populateDropDrown
        settings.onDataRequest.call(this, "search", query, mentionType, function (responseData) {
          if (responseData && responseData.length < 1) {
            isMentionsRequestReq = false;
          } else {
            isMentionsRequestReq = true;
            lastPositionWithResults = inputBuffer.length;
          }

          populateDropdown(query, responseData);
        });
      } else {
        //If the query is null, undefined, empty or has not the minimun chars
    ...
    function getCaretCoordinates(element) {
      ...
      // transfer the element's properties to the mirrorDiv
    ...
    function positionAutocomplete(elmAutocompleteList, elmInputBox, query) {
      var position = getCaretCoordinates(elmInputBox[0]);
      elmAutocompleteList.css("left", position.left);
      elmAutocompleteList.css("top", 25 + position.top);
      if (elmInputBox.width() < 400) {
        elmAutocompleteList.css("width", "17em");
      } else {
        elmAutocompleteList.css("width", "23em");
      }
      var postText = getInputBoxValue();
      postText = postText.substring(0, elmInputBox[0].selectionStart);
      var forTags = !(postText.lastIndexOf("@") > postText.lastIndexOf("#"));
      if (!forTags && query == "") {
        elmAutocompleteList.css("width", "10em");
      } else if (forTags && query == "") {
        elmAutocompleteList.css("width", "16em");
      }
      ...
      if (elmInputBoxRight <= elmAutocompleteListRight) {
        elmAutocompleteList.css("left", position.left - (-5 + elmAutocompleteListRight - elmInputBoxRight));
        if (elmAutocompleteList.offset().left < 0) {
          elmAutocompleteList.css("left", 0);
        }
      }

      var winBottom = $(window).scrollTop() + $(window).height(),
        elmAutocompleteListBottom = elmAutocompleteList.offset().top + elmAutocompleteList.children().height();
      if (
        "pyMessage" != elmInputBox.attr("id") &&
        winBottom < elmAutocompleteListBottom &&
        !$("html").hasClass("phone")
      ) {
        elmAutocompleteList.css("top", position.top - elmAutocompleteList.children().height());
      }
    }
  ...
  $.fn.mentionsInput = function (method, settings) {
    ...
    return this.each(function () {
      ...
      // if(pega.p.mentionsInstance == null)
      pega.p.mentionsInstance = instance;
